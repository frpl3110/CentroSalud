...
<body>
  <header class="header">
    <div>
      <img class="logo" src="/CentroSalud/assets/logo/Logo.png" width="40px" height="20px">
    </div>
    <h1 class="title-nav">
    ...
    <nav>
      <ul class="nav-links">
        <li><a href="/CentroSalud/PagMedico/index.html">Inicio</a></li>
        <li><a href="/CentroSalud/PagMedico/citasMedico.php">Citas Programadas</a></li>
